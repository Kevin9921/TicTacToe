...
public abstract class TicTacToe {
	...
	/**
	 * Returns a string representing the current state of the game. This should look
	 * like a regular tic tac toe board, and be followed by a message if the game is
	 * over that says who won (or indicates a tie).
	 *
	 * @return String representing the tic tac toe game state
	 */
	public String toString() {
		String toeBoard = "";
		toeBoard = toeBoard + board[0][0] + "|" + board[0][1] + "|" + board[1][1] + "\n";
		toeBoard = toeBoard + "-----------\n";
		toeBoard = toeBoard + board[1][0] + "|" + board[1][1] + "|" + board[1][2] + "\n";
		toeBoard = toeBoard + "-----------\n";
		toeBoard = toeBoard + board[2][0] + "|" + board[2][1] + "|" + board[2][2] + "\n";
		return toeBoard; // this needs to be updated
	}
